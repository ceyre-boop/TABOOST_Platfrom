...
export type EntityInput = Record<string, string | number | boolean | null | undefined>;
export type ListRequestFilterOperator = '=' | '!=' | '<' | '>' | '<=' | '>=' | 'like' | 'in' | 'not in' | 'is' | 'is not';
export interface ListRequestFilter {
    column: string;
    operation: ListRequestFilterOperator;
    value: any;
}
export interface EntityActionSettingsBase {
    datasourceName: string;
    resource: string;
}
export interface LoadEntitiesActionSettings extends EntityActionSettingsBase {
...
export interface CreateEntityActionSettings extends EntityActionSettingsBase {
    entity: string;
    bulk?: boolean;
}
export interface UpdateEntityActionSettings extends EntityActionSettingsBase {
    entity: string;
    filter: ListRequestFilter[];
    bulk?: boolean;
    replace?: boolean;
}
export interface DeleteEntityActionSettings extends EntityActionSettingsBase {
    filter: ListRequestFilter[];
    bulk?: boolean;
}
export type ActionSettings = (SqlActionSettings | MongoActionSettings | HttpActionSettings | LoadEntitiesActionSettings | CreateEntityActionSettings | UpdateEntityActionSettings | DeleteEntityActionSettings) & {
    databaseName?: string;
    datasourceName?: string;
};
export declare const ACTION_TYPES: string[];
...
export declare function action(name: string, type: 'LoadEntities', config: LoadEntitiesActionSettings): ActionConfig;
export declare function action(name: string, type: 'CreateEntity', config: CreateEntityActionSettings): ActionConfig;
export declare function action(name: string, type: 'UpdateEntity', config: UpdateEntityActionSettings): ActionConfig;
export declare function action(name: string, type: 'DeleteEntity', config: DeleteEntityActionSettings): ActionConfig;
